...
<body>
    <?php if($updatedBy == "fxguser"){ ?>
        <div class="alert">
          ...
          Notice! You now have the ability to create your own unique user account and as such the default "fxguser" account will be removed on 6/30. Please create a personal account using the "Add a User" button above using your FedEx ID and password of your choice.
        </div>
    <?php } ?>
    <div class="mdc-card">
